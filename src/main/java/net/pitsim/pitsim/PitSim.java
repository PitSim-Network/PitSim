...
import net.pitsim.pitsim.adarkzone.altar.BiomeChanger;
import net.pitsim.pitsim.adarkzone.notdarkzone.EquipmentType;
import net.pitsim.pitsim.adarkzone.notdarkzone.PitEquipment;
import net.pitsim.pitsim.adarkzone.notdarkzone.ShieldManager;
import net.pitsim.pitsim.adarkzone.progression.ProgressionManager;
import net.pitsim.pitsim.ahelp.HelpManager;
import net.pitsim.pitsim.aitems.diamond.*;
import net.pitsim.pitsim.aitems.misc.*;
import net.pitsim.pitsim.aitems.mobdrops.*;
import net.pitsim.pitsim.aitems.mystics.*;
import net.pitsim.pitsim.aserverstatistics.StatisticsManager;
import net.pitsim.pitsim.auction.AuctionDisplays;
import net.pitsim.pitsim.auction.AuctionManager;
import net.pitsim.pitsim.battlepass.PassManager;
import net.pitsim.pitsim.battlepass.quests.*;
import net.pitsim.pitsim.battlepass.quests.daily.DailyBotKillQuest;
import net.pitsim.pitsim.battlepass.quests.daily.DailyMegastreakQuest;
import net.pitsim.pitsim.battlepass.quests.daily.DailyPlayerKillQuest;
import net.pitsim.pitsim.battlepass.quests.daily.DailySWGamePlayedQuest;
import net.pitsim.pitsim.battlepass.quests.dzkillmobs.*;
import net.pitsim.pitsim.boosters.*;
import net.pitsim.pitsim.brewing.BrewingManager;
import net.pitsim.pitsim.brewing.PotionManager;
import net.pitsim.pitsim.commands.*;
import net.pitsim.pitsim.commands.admin.*;
import net.pitsim.pitsim.commands.beta.*;
import net.pitsim.pitsim.commands.essentials.*;
import net.pitsim.pitsim.controllers.*;
import net.pitsim.pitsim.controllers.objects.*;
import net.pitsim.pitsim.cosmetics.CosmeticManager;
import net.pitsim.pitsim.cosmetics.PitCosmetic;
import net.pitsim.pitsim.cosmetics.aura.*;
import net.pitsim.pitsim.cosmetics.bounty.*;
import net.pitsim.pitsim.cosmetics.capes.*;
import net.pitsim.pitsim.cosmetics.killeffectsbot.AlwaysExe;
import net.pitsim.pitsim.cosmetics.killeffectsbot.IronKill;
import net.pitsim.pitsim.cosmetics.killeffectsbot.OnlyExe;
import net.pitsim.pitsim.cosmetics.killeffectsbot.Tetris;
import net.pitsim.pitsim.cosmetics.killeffectsplayer.*;
import net.pitsim.pitsim.cosmetics.misc.ElectricPresence;
import net.pitsim.pitsim.cosmetics.misc.Halo;
import net.pitsim.pitsim.cosmetics.misc.KyroCosmetic;
import net.pitsim.pitsim.cosmetics.misc.MysticPresence;
import net.pitsim.pitsim.cosmetics.trails.*;
import net.pitsim.pitsim.enchants.overworld.*;
import net.pitsim.pitsim.enchants.tainted.chestplate.*;
import net.pitsim.pitsim.enchants.tainted.common.*;
import net.pitsim.pitsim.enchants.tainted.scythe.*;
import net.pitsim.pitsim.enchants.tainted.uncommon.*;
import net.pitsim.pitsim.enchants.tainted.uncommon.basic.*;
import net.pitsim.pitsim.enums.NBTTag;
import net.pitsim.pitsim.enums.PitCalendarEvent;
import net.pitsim.pitsim.events.EquipmentChangeEvent;
import net.pitsim.pitsim.helmetabilities.*;
import net.pitsim.pitsim.holograms.HologramManager;
import net.pitsim.pitsim.killstreaks.Leech;
import net.pitsim.pitsim.killstreaks.*;
import net.pitsim.pitsim.kits.EssentialKit;
import net.pitsim.pitsim.kits.GoldKit;
import net.pitsim.pitsim.kits.PvPKit;
import net.pitsim.pitsim.kits.XPKit;
import net.pitsim.pitsim.leaderboards.*;
...
import net.pitsim.pitsim.npcs.*;
import net.pitsim.pitsim.perks.*;
import net.pitsim.pitsim.pitmaps.BiomesMap;
import net.pitsim.pitsim.pitmaps.DimensionsMap;
import net.pitsim.pitsim.pitmaps.SandMap;
import net.pitsim.pitsim.pitmaps.XmasMap;
import net.pitsim.pitsim.placeholders.*;
import net.pitsim.pitsim.settings.scoreboard.*;
...
//		Rare
		...
		EnchantManager.registerEnchant(new net.pitsim.pitsim.enchants.tainted.scythe.Leech());
