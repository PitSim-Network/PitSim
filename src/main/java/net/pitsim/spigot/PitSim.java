...
import net.pitsim.spigot.adarkzone.altar.AltarManager;
import net.pitsim.spigot.adarkzone.altar.BiomeChanger;
import net.pitsim.spigot.adarkzone.notdarkzone.EquipmentType;
import net.pitsim.spigot.adarkzone.notdarkzone.PitEquipment;
import net.pitsim.spigot.adarkzone.notdarkzone.ShieldManager;
import net.pitsim.spigot.adarkzone.progression.ProgressionManager;
import net.pitsim.spigot.ahelp.HelpManager;
import net.pitsim.spigot.aitems.diamond.*;
import net.pitsim.spigot.aitems.misc.*;
import net.pitsim.spigot.aitems.mobdrops.*;
import net.pitsim.spigot.aitems.mystics.*;
