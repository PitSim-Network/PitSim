...
import net.pitsim.spigot.items.diamond.DiamondBoots;
import net.pitsim.spigot.items.diamond.DiamondChestplate;
import net.pitsim.spigot.items.diamond.DiamondHelmet;
