...
//			if(prestige == 50) return "&f|";
	...
	static {
		...
		prestigeMap.put(1, new PrestigeInfo(1, 1.2, 40_000, 0, 20, "&9")); //tenacity gboost xp
		prestigeMap.put(2, new PrestigeInfo(2, 1.5, 60_000, 0, 20, "&9"));
		prestigeMap.put(3, new PrestigeInfo(3, 2.0, 80_000, 0, 20, "&9"));
		prestigeMap.put(4, new PrestigeInfo(4, 2.5, 100_000, 0, 20, "&9"));
		prestigeMap.put(5, new PrestigeInfo(5, 3.0, 120_000, 50, 20, "&e")); //lucky kill
		prestigeMap.put(6, new PrestigeInfo(6, 3.5, 140_000, 50, 20, "&e")); //impatient
		prestigeMap.put(7, new PrestigeInfo(7, 4.0, 160_000, 50, 20, "&e")); //streaker
		prestigeMap.put(8, new PrestigeInfo(8, 4.5, 180_000, 50, 20, "&e"));
		prestigeMap.put(9, new PrestigeInfo(9, 5.0, 200_000, 50, 20, "&e")); //doubledeath
		prestigeMap.put(10, new PrestigeInfo(10, 6.0, 300_000, 100, 25, "&6")); //firststrike
		prestigeMap.put(11, new PrestigeInfo(11, 7.0, 400_000, 100, 25, "&6"));
		prestigeMap.put(12, new PrestigeInfo(12, 8.0, 500_000, 100, 25, "&6")); //lifeinsurance
		prestigeMap.put(13, new PrestigeInfo(13, 10.0, 650_000, 100, 25, "&6")); //beast
		prestigeMap.put(14, new PrestigeInfo(14, 12.0, 800_000, 100, 25, "&6")); //counter-janitor
		prestigeMap.put(15, new PrestigeInfo(15, 14.0, 1_000_000, 150, 30, "&c")); //helmetry
		prestigeMap.put(16, new PrestigeInfo(16, 16.0, 1_300_000, 150, 30, "&c")); //divine
		prestigeMap.put(17, new PrestigeInfo(17, 18.0, 1_600_000, 150, 30, "&c")); //highlander
		prestigeMap.put(18, new PrestigeInfo(18, 21.0, 1_700_000, 150, 30, "&c")); //withercraft
		prestigeMap.put(19, new PrestigeInfo(19, 24.0, 1_800_000, 150, 30, "&c"));
		prestigeMap.put(20, new PrestigeInfo(20, 27.0, 2_000_000, 300, 35, "&5")); //uber
		prestigeMap.put(21, new PrestigeInfo(21, 30.0, 2_300_000, 300, 35, "&5"));
		prestigeMap.put(22, new PrestigeInfo(22, 35.0, 2_600_000, 300, 35, "&5")); //taxevasion
		prestigeMap.put(23, new PrestigeInfo(23, 40.0, 2_900_000, 300, 35, "&5")); //complex
		prestigeMap.put(24, new PrestigeInfo(24, 45.0, 3_200_000, 300, 35, "&5"));
		prestigeMap.put(25, new PrestigeInfo(25, 50.0, 3_500_000, 500, 40, "&d")); //uberincrease
		prestigeMap.put(26, new PrestigeInfo(26, 60.0, 3_800_000, 500, 40, "&d"));
		prestigeMap.put(27, new PrestigeInfo(27, 70.0, 3_100_000, 500, 40, "&d")); //killsteal
		prestigeMap.put(28, new PrestigeInfo(28, 80.0, 4_400_000, 500, 40, "&d")); //shard
		prestigeMap.put(29, new PrestigeInfo(29, 90.0, 4_700_000, 500, 40, "&d"));
		prestigeMap.put(30, new PrestigeInfo(30, 200.0, 5_000_000, 2_000, 45, "&f")); //moon
		prestigeMap.put(31, new PrestigeInfo(31, 210.0, 5_300_000, 2_000, 45, "&f"));
		prestigeMap.put(32, new PrestigeInfo(32, 220.0, 5_600_000, 2_000, 45, "&f"));
		prestigeMap.put(33, new PrestigeInfo(33, 230.0, 6_000_000, 2_000, 45, "&f"));
		prestigeMap.put(34, new PrestigeInfo(34, 240.0, 6_400_000, 2_000, 45, "&f"));
		prestigeMap.put(35, new PrestigeInfo(35, 250.0, 6_800_000, 2_500, 50, "&b")); //withercraft
		prestigeMap.put(36, new PrestigeInfo(36, 260.0, 7_200_000, 2_500, 50, "&b"));
		prestigeMap.put(37, new PrestigeInfo(37, 270.0, 7_600_000, 2_500, 50, "&b"));
		prestigeMap.put(38, new PrestigeInfo(38, 280.0, 8_000_000, 2_500, 50, "&b")); //Fast pass
		prestigeMap.put(39, new PrestigeInfo(39, 290.0, 9_000_000, 2_500, 50, "&b"));
		prestigeMap.put(40, new PrestigeInfo(40, 400.0, 40_000_000, 7_000, 55, "&3")); //celebrity
		prestigeMap.put(41, new PrestigeInfo(41, 410.0, 45_000_000, 7_000, 60, "&3"));
		prestigeMap.put(42, new PrestigeInfo(42, 425.0, 50_000_000, 7_000, 65, "&3"));
		prestigeMap.put(43, new PrestigeInfo(43, 450.0, 55_000_000, 7_000, 70, "&3"));
		prestigeMap.put(44, new PrestigeInfo(44, 475.0, 60_000_000, 7_000, 75, "&3"));
		prestigeMap.put(45, new PrestigeInfo(45, 500.0, 65_000_000, 10_000, 80, "&1"));
		prestigeMap.put(46, new PrestigeInfo(46, 550.0, 70_000_000, 10_000, 85, "&1"));
		prestigeMap.put(47, new PrestigeInfo(47, 600.0, 80_000_000, 10_000, 90, "&1"));
		prestigeMap.put(48, new PrestigeInfo(48, 750.0, 90_000_000, 10_000, 95, "&1"));
		...
		prestigeMap.put(55, new PrestigeInfo(55, 10_000, 500_000_000, 25_000, 120, "&0"));
