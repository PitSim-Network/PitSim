...
public class FireworkSparkParticle extends PitParticle {
	public FireworkSparkParticle() {
	}

	public FireworkSparkParticle(boolean accountForPitch, boolean accountForYaw) {
