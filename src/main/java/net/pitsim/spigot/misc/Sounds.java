...
public class Sounds {
	...
	public static final SoundEffect ALTAR_ROLL = new SoundEffect(Sound.WITHER_SPAWN, 1, 1);
	...
	public static final SoundEffect OUTPOST = new SoundEffect(Sound.ZOMBIE_WOODBREAK, 0.5, 1.2);
