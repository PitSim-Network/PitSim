...
//			if(prestige == 50) return "&f|";
	...
	static {
		...
		prestigeMap.put(10, new PrestigeInfo(10, 6.0, 300_000, 50, 14, "&6")); //firststrike
		prestigeMap.put(11, new PrestigeInfo(11, 7.0, 400_000, 50, 14, "&6"));
		prestigeMap.put(12, new PrestigeInfo(12, 8.0, 500_000, 50, 15, "&6")); //lifeinsurance
		prestigeMap.put(13, new PrestigeInfo(13, 10.0, 650_000, 50, 15, "&6")); //beast
		prestigeMap.put(14, new PrestigeInfo(14, 12.0, 800_000, 50, 16, "&6")); //counter-janitor
		prestigeMap.put(15, new PrestigeInfo(15, 14.0, 1_000_000, 100, 16, "&c")); //helmetry
		prestigeMap.put(16, new PrestigeInfo(16, 16.0, 1_300_000, 100, 16, "&c")); //divine
		prestigeMap.put(17, new PrestigeInfo(17, 18.0, 1_600_000, 100, 16, "&c")); //highlander
		prestigeMap.put(18, new PrestigeInfo(18, 21.0, 1_700_000, 100, 18, "&c")); //withercraft
		prestigeMap.put(19, new PrestigeInfo(19, 24.0, 1_800_000, 100, 20, "&c"));
		prestigeMap.put(20, new PrestigeInfo(20, 27.0, 2_000_000, 200, 20, "&5")); //uber
		prestigeMap.put(21, new PrestigeInfo(21, 30.0, 2_300_000, 200, 20, "&5"));
		prestigeMap.put(22, new PrestigeInfo(22, 35.0, 2_600_000, 200, 20, "&5")); //taxevasion
		prestigeMap.put(23, new PrestigeInfo(23, 40.0, 2_900_000, 200, 22, "&5")); //complex
		prestigeMap.put(24, new PrestigeInfo(24, 45.0, 3_200_000, 200, 24, "&5"));
		prestigeMap.put(25, new PrestigeInfo(25, 50.0, 3_500_000, 400, 24, "&d")); //uberincrease
		prestigeMap.put(26, new PrestigeInfo(26, 60.0, 3_800_000, 400, 24, "&d"));
		prestigeMap.put(27, new PrestigeInfo(27, 70.0, 3_100_000, 400, 26, "&d")); //killsteal
		prestigeMap.put(28, new PrestigeInfo(28, 80.0, 4_400_000, 400, 28, "&d")); //shard
		prestigeMap.put(29, new PrestigeInfo(29, 90.0, 4_700_000, 400, 30, "&d"));
		prestigeMap.put(30, new PrestigeInfo(30, 200.0, 5_000_000, 1_000, 30, "&f")); //moon
		prestigeMap.put(31, new PrestigeInfo(31, 210.0, 5_300_000, 1_000, 30, "&f"));
		prestigeMap.put(32, new PrestigeInfo(32, 220.0, 5_600_000, 1_000, 32, "&f"));
		prestigeMap.put(33, new PrestigeInfo(33, 230.0, 6_000_000, 1_000, 34, "&f"));
		prestigeMap.put(34, new PrestigeInfo(34, 240.0, 6_400_000, 1_000, 36, "&f"));
		prestigeMap.put(35, new PrestigeInfo(35, 250.0, 6_800_000, 1_000, 36, "&b")); //withercraft
		prestigeMap.put(36, new PrestigeInfo(36, 260.0, 7_200_000, 1_000, 36, "&b"));
		prestigeMap.put(37, new PrestigeInfo(37, 270.0, 7_600_000, 1_000, 38, "&b"));
		prestigeMap.put(38, new PrestigeInfo(38, 280.0, 8_000_000, 1_000, 40, "&b")); //Fast pass
		prestigeMap.put(39, new PrestigeInfo(39, 290.0, 9_000_000, 1_000, 42, "&b"));
		prestigeMap.put(40, new PrestigeInfo(40, 400.0, 40_000_000, 5_000, 42, "&3")); //celebrity
		prestigeMap.put(41, new PrestigeInfo(41, 410.0, 45_000_000, 5_000, 42, "&3"));
		prestigeMap.put(42, new PrestigeInfo(42, 425.0, 50_000_000, 5_000, 44, "&3"));
		prestigeMap.put(43, new PrestigeInfo(43, 450.0, 55_000_000, 5_000, 46, "&3"));
		prestigeMap.put(44, new PrestigeInfo(44, 475.0, 60_000_000, 5_000, 48, "&3"));
		prestigeMap.put(45, new PrestigeInfo(45, 500.0, 65_000_000, 5_000, 50, "&1"));
		prestigeMap.put(46, new PrestigeInfo(46, 550.0, 70_000_000, 5_000, 60, "&1"));
		prestigeMap.put(47, new PrestigeInfo(47, 600.0, 80_000_000, 5_000, 70, "&1"));
		prestigeMap.put(48, new PrestigeInfo(48, 750.0, 90_000_000, 5_000, 80, "&1"));
		prestigeMap.put(49, new PrestigeInfo(49, 1_000.0, 100_000_000, 5_000, 100, "&1"));
		...
		prestigeMap.put(55, new PrestigeInfo(55, 25_000.0, 500_000_000, 20_000, 120, "&0"));
		prestigeMap.put(56, new PrestigeInfo(56, 40_000.0, 600_000_000, 20_000, 140, "&0"));
		prestigeMap.put(57, new PrestigeInfo(57, 60_000.0, 700_000_000, 20_000, 160, "&0"));
		prestigeMap.put(58, new PrestigeInfo(58, 80_000.0, 850_000_000, 20_000, 180, "&0"));
		prestigeMap.put(59, new PrestigeInfo(59, 100_000.0, 1_000_000_000, 20_000, 10_000, "&0"));
		prestigeMap.put(60, new PrestigeInfo(60, 1_000_000.0, 0, 0, 120, "&4"));
