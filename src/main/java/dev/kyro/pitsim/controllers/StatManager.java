...
public class StatManager implements Listener {
	...
	public void onAttack(AttackEvent.Apply attackEvent) {
		...
		if(pitAttacker.stats != null) {
			...
			pitAttacker.stats.damageDealt += attackEvent.getWrapperEvent().getSpigotEvent().getFinalDamage();
		...
		if(pitDefender.stats != null) {
			pitDefender.stats.damageTaken += attackEvent.getWrapperEvent().getSpigotEvent().getFinalDamage();
