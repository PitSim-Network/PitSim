...
public class ExplosionLargeParticle extends PitParticle {
	public ExplosionLargeParticle() {
	}

	public ExplosionLargeParticle(boolean accountForPitch, boolean accountForYaw) {
