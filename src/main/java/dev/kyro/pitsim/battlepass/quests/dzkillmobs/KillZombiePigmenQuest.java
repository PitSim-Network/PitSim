...
import dev.kyro.pitsim.mobs.OldPitZombiePigman;
...
public class KillZombiePigmenQuest extends PassQuest {
	...
	public void onKill(KillEvent killEvent) {
		...
		if(!OldMobManager.mobIsType(killEvent.getDead(), OldPitZombiePigman.class)) return;
	...
	public ItemStack getDisplayItem(PitPlayer pitPlayer, QuestLevel questLevel, double progress) {
		ItemStack itemStack = new AItemStackBuilder(Material.PORK)
				...
				.setLore(new ALoreBuilder(
						"&7Kill &c" + Misc.formatLarge(questLevel.getRequirement(pitPlayer)) + " &7zombie pigmen",
						"",
