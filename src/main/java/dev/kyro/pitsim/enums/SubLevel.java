...
import dev.kyro.pitsim.adarkzone.old.slayers.SkeletonBossOld;
import dev.kyro.pitsim.adarkzone.old.slayers.ZombieBossOld;
...
public enum SubLevel {
	...
	WITHER_CAVE(8, 20, new Location(Bukkit.getWorld("darkzone"), 247, 21, -174),
			...
			Arrays.asList(PitWitherSkeleton.class), SkeletonBossOld.class, 5),
	GOLEM_CAVE(9, 20, new Location(Bukkit.getWorld("darkzone"), 313, 20, -217),
			NBTTag.GOLEM_INGOT, "&aIron Ingot", "%pitsim_golemcave%", 17,
			Arrays.asList(PitIronGolem.class), SkeletonBossOld.class, 4),
	ENDERMAN_CAVE(10, 20, new Location(Bukkit.getWorld("darkzone"), 388, 20, -226),
			...
			Arrays.asList(PitEnderman.class), SkeletonBossOld.class, 3);
