...
public enum SubLevel {
	...
	DEEP_SPIDER_CAVE(5, 30, new Location(Bukkit.getWorld("darkzone"), -10, 22, -79), NBTTag.CAVESPIDER_EYE, "&aFermented Spider Eye", "%pitsim_deepspidercave%", 20, Arrays.asList(PitCaveSpider.class), SkeletonBoss.class);
//	MAGMA_CUBE,
//	WITHER_SKELETON,
//	IRON_GOLEM,
//	SPIDER,
