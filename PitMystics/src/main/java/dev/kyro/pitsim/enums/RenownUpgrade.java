...
public enum RenownUpgrade {
    GOLD_BOOST("Renown Gold Boost", 10, 0, true, 10, RenownUpgradeDisplays.goldBoostCosts),
    XP_BOOST("Renown XP Boost", 10,  1, true, 10, RenownUpgradeDisplays.XPBoostCosts),
    TENACITY("Tenacity", 10,  2, true, 2, RenownUpgradeDisplays.TenacityCosts);
    ...
    RenownUpgrade(String refName, int renownCost, int slot, boolean
