...
//		return Arrays.asList(10, 13, 16, 19, 22, 25, 30, 35, 40, 50,    75, 100, 125, 150, 200    250, 300, 350, 400, 500);
	...
	public void onKill(KillEvent killEvent) {
		...
		if(helmet != null) {
			...
			if(killEvent.killer.getInventory().getHelmet().getType() == Material.GOLD_HELMET)
				chance += 0.0001 * HelmetSystem.getTotalStacks(HelmetSystem.Passive.SHARD_CHANCE,level - 1);
		}
