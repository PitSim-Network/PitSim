...
public class LeaderboardPlaceholder7 implements APAPIPlaceholder {
	...
	public String getValue(Player player) {
		...
		FileConfiguration key = (FileConfiguration) NewLeaderboardManager.sortedMap.keySet().toArray()[NewLeaderboardManager.sortedMap.size() - 7];
		...
		return ChatColor.translateAlternateColorCodes('&', "&77. " + builder.toString() + levelBuilder.toString());
	}
}
