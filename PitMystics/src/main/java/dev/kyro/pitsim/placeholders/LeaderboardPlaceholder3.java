...
public class LeaderboardPlaceholder3 implements APAPIPlaceholder {
	...
	public String getValue(Player player) {
		...
		FileConfiguration key = (FileConfiguration) NewLeaderboardManager.sortedMap.keySet().toArray()[NewLeaderboardManager.sortedMap.size() - 3];
		...
		return ChatColor.translateAlternateColorCodes('&', "&73. " + builder.toString() + levelBuilder.toString());
	}
}
