...
public class LeaderboardPlaceholder4 implements APAPIPlaceholder {
	...
	public String getValue(Player player) {
		...
		FileConfiguration key = (FileConfiguration) NewLeaderboardManager.sortedMap.keySet().toArray()[NewLeaderboardManager.sortedMap.size() - 4];
		...
		return ChatColor.translateAlternateColorCodes('&', "&74. " + builder.toString() + levelBuilder.toString());
	}
}
