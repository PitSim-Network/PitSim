...
public class LeaderboardPlaceholder10 implements APAPIPlaceholder {
	...
	public String getValue(Player player) {
		...
		FileConfiguration key = (FileConfiguration) NewLeaderboardManager.sortedMap.keySet().toArray()[NewLeaderboardManager.sortedMap.size() - 10];
		...
		return ChatColor.translateAlternateColorCodes('&', "&710. " + builder.toString() + levelBuilder.toString());
	}
}
