...
public class LeaderboardPlaceholder5 implements APAPIPlaceholder {
	...
	public String getValue(Player player) {
		...
		FileConfiguration key = (FileConfiguration) NewLeaderboardManager.sortedMap.keySet().toArray()[NewLeaderboardManager.sortedMap.size() - 5];
		...
		return ChatColor.translateAlternateColorCodes('&', "&75. " + builder.toString() + levelBuilder.toString());
	}
}
