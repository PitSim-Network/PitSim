...
public enum TutorialMessage {
    ...
    MYSTIC2("&eOur combat system revolves around &fMystic Items&e.", "Our combat system revolves around"),
    ...
    ARMOR1("&eGreat job!, you now have one of each type of &fMystic Item&e!", "Great job!, you now have one of each type of"),
