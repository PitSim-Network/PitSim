...
public class JudgementAbility extends HelmetAbility {
	...
	public void onAttack(AttackEvent.Apply attackEvent) {
		...
		if(!goldenHelmet.withdrawGold(6474)) {
	...
	public void onActivate() {
		...
		AOutput.send(player, "&6&lGOLDEN HELMET! &aActivated &9Judgement&7. (&6-6,474g&7 per hit)");
	}
	...
	public boolean shouldActivate() {
		...
		assert goldenHelmet != null;
		if(PitSim.VAULT.getBalance(player) < 6474) {
